                ...
                Thread thread = new Thread() {
                    public void run() {
                        ...
                        try {
                            ...
                            String message = "Hello RabbitMQ" + rabbitconfig.getRabbitmqQueueName();
                            if (rabbitconfig.getRabbitmqQueueName().equals("test3") && j > 0) {
                                j--;
                                message = "Error";
                            }
                            ...
                            System.out.println(MessageFormat.format("Producer queueName={0} Send {1} ",
                                    rabbitconfig.getRabbitmqQueueName(), message));
                            //关闭通道和连接
                            channel.close();
